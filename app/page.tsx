...
export default function HomePage() {
  useEffect(() => {
    ...
    const schema = {
      ...
      "description": "En unik musikfestival i Dronningedalen ved Løgumkloster, Sønderjylland med live musik, koncerter og fællesskab",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg leading-relaxed opacity-90">
                Tak for en fantastisk festival i 2026! Vi glæder os til at se jer igen til Mellem Træerne 2027. 
                Køb dine billetter nu til kun 349 kr. 
                Oplev igen live musik og fællesskab i de smukke omgivelser i Dronningedalen ved Løgumkloster.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-secondary text-secondary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Vores musikfestival i Løgumkloster skabes af frivillige, der brænder for live musik, 
              kulturarrangementer og fællesskab i Sønderjylland. Bliv en del af holdet bag festivalen.
            </p>
